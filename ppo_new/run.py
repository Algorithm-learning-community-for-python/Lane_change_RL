...
def callback(locals_, globals_):
    ...
    if MPI.COMM_WORLD.Get_rank() == 0 and iters_so_far_ % 30 == 0:
        saver_.save(sess_, model_dir + '/model', global_step=iters_so_far_)
    return True
